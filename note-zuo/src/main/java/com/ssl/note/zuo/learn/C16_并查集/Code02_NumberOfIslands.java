package com.ssl.note.zuo.learn.C16_并查集;
...
public class Code02_NumberOfIslands {
     ...
     * 方法：递归感染
     * 时间复杂度：O(m*n)
     * 因为：主过程中每个位置都被碰了1遍，所有的感染过程里每个感染位置只被碰到4遍
     * 加起来每个位置最多只被碰到5遍，O(5*m*n)=O(m*n)
     */
    ...
    public static int numIslands1(char[][] board) {
        ...
        // 将board转换为DotList
        // 因为UnionFind1种使用的是泛型，而原始数组时基本数据类型
        ...
        // UnionFind1；使用泛型初试化dotList
        UnionFind1<Dot> uf = new UnionFind1<>(dotList);
        // 分开判断，比写两个for循环快，因为减少了判断操作
        // 第0行
        for (int j = 1; j < col; j++) {
            // (0,j)  (0,0)既没有上也有左跳过了 (0,1) (0,2) (0,3)
